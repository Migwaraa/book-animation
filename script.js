document.addEventListener('DOMContentLoaded', () => {
    ...
    const lyrics = [
        { time: 0, text: "“Terima kasih, ” katanya" },
        { time: 6, text: "Semua aku dirayakan" },
        { time: 11, text: "“Jangan menangis, ”" },
        { time: 15, text: "ku dibuai sampai tenang" },
        { time: 20, text: "........" },
        { time: 24, text: "Diciumnya api marahku" },
        { time: 29, text: "Ternyata kacau bisa luluh" },
        { time: 36, text: "“Jangan menangis”" },
        { time: 39, text: "Biar tenang ku dibuai" },
        { time: 45, text: "........" },
        { time: 49, text: "Jika malam datang dan takut menyerang" },
    ];
